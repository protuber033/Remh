...
1. Voeg een dienst toe in `data/services.json` (inclusief `highlights` voor de chips en gallery-teksten).
2. Run `python app.py build`.
3. Een nieuwe pagina + driedelige illustratieset verschijnt automatisch.
